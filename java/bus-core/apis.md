...
| [OutboxPublisher](./com.euonia.bus.OutboxPublisher.md) | class | 发件箱发布器 |
...
| 类 | 类型 | 说明 |
|----|------|------|
| [InboxCompletionBehavior](./com.euonia.bus.behavior.InboxCompletionBehavior.md) | class | 收件箱完成行为 |
| [IncomingLoggingBehavior](./com.euonia.bus.behavior.IncomingLoggingBehavior.md) | class | 入站消息日志行为 |
| [OutboxCompletionBehavior](./com.euonia.bus.behavior.OutboxCompletionBehavior.md) | class | 发件箱完成行为 |
...
### com.euonia.bus.handle

处理器运行时实现。

| 类 | 类型 | 说明 |
|----|------|------|
| [DefaultHandlerContext](./com.euonia.bus.handle.DefaultHandlerContext.md) | class | 默认处理器上下文（注册+调用） |
| [HandlerDelegate](./com.euonia.bus.handle.HandlerDelegate.md) | class | 处理器委托 |
| [HandlerFactory](./com.euonia.bus.handle.HandlerFactory.md) | class | 处理器工厂 |
| [HandlerRegistration](./com.euonia.bus.handle.HandlerRegistration.md) | record | 处理器注册元组 |
| [IdempotentHandler](./com.euonia.bus.handle.IdempotentHandler.md) | class | 幂等处理器装饰器 |
