...
| [PipelineMessage](./com.euonia.bus.PipelineMessage.md) | class | 绑定消息和管道的包装类 |
...
| [InboxCompletionBehavior](./com.euonia.bus.handle.InboxCompletionBehavior.md) | class | 收件箱完成行为 |
