...
### `ObservableList(Collection<? extends TItem> items)`
...
### `isRaiseListChangedEvents(): boolean`

> 获取一个值，指示是否在列表项属性更改或集合结构更改时引发事件。

**Returns:** `boolean` — 如果在列表项属性更改或集合结构更改时引发事件，则返回 true；否则返回 false

### `setRaiseListChangedEvents(boolean raiseListChangedEvents): void`
...
### `addChildChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `removeChildChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `addItemPropertyChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `removeItemPropertyChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `addCollectionChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `removeCollectionChangedListener(Consumer<ObjectChangedEventArgs> listener): void`
...
### `addBusyChangedListener(Consumer<Boolean> listener): void`
...
### `removeBusyChangedListener(Consumer<Boolean> listener): void`
...
### `addAll(Collection<? extends TItem> items): boolean`
...
### `addAll(int index, Collection<? extends TItem> items): boolean`
...
### `set(int index, TItem item): TItem`
