...
### `markAsDeleted(boolean checkObjectRules): void`
...
### `onBusyChanged(Consumer<Boolean> listener): void`
...
### `<V> getProperty(PropertyInfo<V> property): V`
...
### `<V> setProperty(PropertyInfo<V> property, V newValue): void`
