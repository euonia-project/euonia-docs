...
### `onSaved(Consumer<SavedEventArgs> listener): void`
...
### `onSaved(T newObject, Throwable error, Object userState): void`
...
### `save(boolean forceUpdate, Object userState): T`
...
**Throws:** `RuleCheckException` — 当对象无效且（未被标记为删除或删除时需检查对象规则）时抛出
...
### `getSavedEventPublisher(): SubmissionPublisher<SavedEventArgs>`
