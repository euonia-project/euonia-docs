...
### com.euonia.bus.inbox

收件箱模式（幂等消费）抽象。

| 类 | 类型 | 说明 |
|----|------|------|
| [InboxEntry](./com.euonia.bus.inbox.InboxEntry.md) | class | 收件箱条目 |
| [InboxHandle](./com.euonia.bus.inbox.InboxHandle.md) | class | 收件箱处理句柄 |
| [InboxStore](./com.euonia.bus.inbox.InboxStore.md) | interface | 收件箱存储接口 |

### com.euonia.bus.outbox

发件箱模式（事务发件）抽象。

| 类 | 类型 | 说明 |
|----|------|------|
| [OutboxEntry](./com.euonia.bus.outbox.OutboxEntry.md) | class | 发件箱条目 |
| [OutboxStore](./com.euonia.bus.outbox.OutboxStore.md) | interface | 发件箱存储接口 |
| [OutboxTransport](./com.euonia.bus.outbox.OutboxTransport.md) | interface | 发件箱传输接口 |
